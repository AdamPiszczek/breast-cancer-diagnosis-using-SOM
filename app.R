...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(width = 4,
            ...
            sliderInput("BI.RADS", 
                         h3("BI.RADS assessment: 1 to 5 (ordinal)"),
                         min = 1,
                         max = 5,
                         value = 2),
            sliderInput("Age", 
                         h3("Age: patient's age in years (integer)"),
                         min = 18,
                         max = 96,
                         value = 42),
            sliderInput("Margin", 
                         h3("Margin: mass margin: circumscribed=1 microlobulated=2 obscured=3 ill-defined=4 spiculated=5 (nominal)"),
                         min = 1,
                         max = 5,
                         value = 3),
            sliderInput("Shape", 
                         h3("Shape: mass shape: round=1 oval=2 lobular=3 irregular=4 (nominal)"),
                         min = 1,
                         max = 4,
                         value = 4),
            sliderInput("Density", 
                         h3("Density: mass density high=1 iso=2 low=3 fat-containing=4 (ordinal)"),
                         min = 1,
                         max = 4,
                         value = 2),
            hr(),
            ...
            radioButtons("distfun", h3("Distance function type"),
                         choices = list("sum of squares" = "sumofsquares",
                                        "euclidean" = "euclidean",
                                        "manhattan" = "manhattan",
                                        "tanimoto" = "tanimoto"),
