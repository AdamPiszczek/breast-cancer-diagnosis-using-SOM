...
hist(Malignant$BI.RADS, breaks = c(1,2,3,4,5), col=rgb(1,0,0,0.5), xlab="values of BI-RADS, from 1 to 5", 
     ylab="counts", main="Histogram of BI-RADS" )

hist(Benign$BI.RADS, breaks = c(1,2,3,4,5), col=rgb(0,0,1,0.5), add=T)
